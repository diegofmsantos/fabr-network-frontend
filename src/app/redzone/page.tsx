  ...
  if (!noticia) {
    return (
      <div className="bg-[#ECECEC] min-h-screen pb-16 pt-[83px] max-w-[800px] mx-auto xl:ml-96 xl:mr-12 2xl:ml-[550px] 2xl:mr-20 2xl:max-w-[1000px]">
        <Link
          href={`/`}
          className='hidden xl:flex fixed top-8 left-5 rounded-full text-xs text-[#63E300] p-2 w-8 h-8 justify-center items-center bg-black/40 z-50 xl:left-[380px] 2xl:left-[550px]'
        >
        ...
        <div className="max-w-4xl mx-auto p-4 mr-1 bg-white text-center py-20">
          ...
          <p className="text-black">Volte na sexta-feira antes do fim de semana de jogos para ver os links das transmissões.</p>
        </div>
      </div>
    )
  }
