...
export default function FinalNacionalPage() {
  ...
  const renderTimeCard = (time: TimeNacional, isVencedor: boolean = false, isFinal: boolean = false) => {
    return (
      <div className={`p-6 rounded-xl border-2 transition-all ${isVencedor
  ...
  const renderJogoCard = (jogo: JogoNacional, expandido: boolean = false) => {
    ...
    return (
      <div className={`bg-[#272731] rounded-2xl border p-8 transition-all ${isFinal ? 'border-[#63E300] shadow-2xl' : 'border-gray-700'
  ...
  return (
    <div className='bg-[#ECECEC]'>
      <div className="min-h-screen bg-[#ECECEC] p-6 max-w-[1200px] mx-auto xl:ml-[510px]">
        <div className="relative bg-[#272731] pt-20 pb-16">
          ...
          <div className="relative max-w-7xl mx-auto px-6">
            ...
            <div className="text-center">
              <div className="flex items-center justify-center gap-4 mb-6">
                ...
                <div>
                  <h1 className="text-5xl md:text-6xl font-extrabold italic tracking-[-5px] text-white mb-2">
                    FASE <span className='ml-3'>NACIONAL</span>
                  </h1>
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="mb-12">
            <h2 className="text-3xl font-extrabold italic tracking-[-2px] text-[#272731] mb-8 text-center">
              🏆 Campeões por Conferência
            </h2>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {Object.entries(faseNacional.campeoesPorConferencia).map(([conf, time]) => (
                <div key={conf} className="bg-[#272731] rounded-xl border border-gray-800 p-6 text-center">
          ...
          {faseNacional.final && (
            <div className="mb-12">
              <h2 className="text-4xl font-extrabold italic tracking-[-2px] text-[#272731] mb-8 text-center">
          ...
          <div className="bg-[#272731] rounded-xl border border-gray-800 p-8">
