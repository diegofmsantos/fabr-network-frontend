        ...
        <div className="w-full border-black bg-[#ECECEC] border-b mt-20 px-3 xl:w-[900px] md:h-14 md:pt-2 xl:ml-[170px] fixed z-50 xl:h-28 xl:pt-12 xl:mt-0">
          <div className="flex items-center justify-between gap-2">
            ...
            <h1 className="text-[20px] min-[375px]:text-[24px] min-[375px]:h-16 min-[375px]:pt-2 min-[425px]:text-[23px] font-extrabold italic leading-[55px] tracking-[-2px]
             text-black md:pt-0 md:h-10 md:text-3xl xl:text-4xl">FINAL DE CONFERÊNCIA</h1>
        ...
        <div className="mt-44 h-full mb-24 ml-3 xl:ml-20">
          <div className="flex flex-col gap-8 min-[375px]:ml-4 min-[425px]:ml-2">
            {(!finalConferencias || finalConferencias.length === 0) ? (
              <div className="text-center py-1 md:ml-40 xl:ml-96"><div className="text-black text-lg">Nenhum jogo de Final de Conferência configurado ainda.</div></div>
            ) : (
